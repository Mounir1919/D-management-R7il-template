        ...
        <div class="header-row justify-content-between flex-row-reverse flex-lg-row">
          ...
          <div class="header-misc">
            ...
            <div class="header-buttons d-none d-sm-inline-block">
              <a href="#slider" data-scrollto="#slider" data-offset="-80" class="button button-rounded button-white button-light button-small m-0">
                Obtenir un devis
              </a>
            </div>
          </div>
          ...
          <nav class="primary-menu with-arrows">
            <ul class="menu-container">
              ...
              <li class="menu-item"><a class="menu-link" href="/notre-entreprise"><div>Notre entreprise</div></a></li>
              <li class="menu-item">
                <a class="menu-link" href="/tarifs"><div>Tarifs</div></a>
              ...
              <li class="menu-item"><a class="menu-link" href="/equipe"><div>Équipe</div></a></li>
