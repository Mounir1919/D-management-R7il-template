<template>
    ...
    <section id="slider" class="slider-element bg-color"
        style="height: auto; padding: 60px 0; background: url('/demos/movers/images/bg-2.png') no-repeat center center / 100% 100%;">
                                    ...
                                    <div class="col-12 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><img
                                                    src="/demos/movers/images/baggage.png" height="18"
    ...
    <section id="content">
        ...
        <div class="content-wrap pb-0">
                ...
                <div class="row justify-content-center mb-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row align-items-center mt-5">
                            ...
                            <div class="col-sm-6">
                                <img src="/demos/movers/images/others/2.png" alt="Image 2">
                            </div>
                        </div>
                        <div class="row align-items-center mt-5">
                            <div class="col-sm-6">
                                <img src="/demos/movers/images/others/1.png" alt="Image 3">
                            </div>
                            <div class="col-sm-6">
            ...
            <div class="section p-0 dark mb-0"
                style="background: linear-gradient(to right, rgba(25,102,221,0.2), rgba(25,102,221,0.5)), url('/demos/movers/images/section/1.jpg') no-repeat center center / cover; min-height: 400px">
                <div class="container">
            ...
            <div class="section-map mb-6 mt-6">
                <div class="container">
                    <img src="/demos/hosting/images/svg/map.png" alt="Carte du Maroc" class="img-fluid map-image">
                    <div class="map-title">
                ...
                <div class="container">
                    <div class="mx-auto mw-lg" style="padding: 120px 0 50px;">
                                ...
                                <div class="bg-white shadow-sm d-flex justify-content-center flex-column rounded">
                                    <div class="d-flex flex-row mb-4 align-items-center">
                                        <a href="#"><img class="rounded-circle"
                                                src="/demos/pet/images/testimonials/1.jpg" alt="Témoignage client"
                        ...
                        <div class="grid-bg d-none d-md-block">
                            <img src="/demos/movers/images/dot-grid.svg" alt="Image décorative">
                        </div>
                    </div>
                </div>
